...
@Component({
  ...
  templateUrl: './voir-personnel.component.html',
  styleUrls: ['./voir-personnel.component.css']
})
export class VoirPersonnelComponent implements OnInit, OnChanges {
...
onFileSelected(event:any) {
  ...
  ngOnChanges(): void {
    this.message = '';
    this.currentPersonnel = { ...this.personnel };
    this.dropdownSettings = {
      singleSelection: false,
      idField: 'key',
      textField: 'nom',
